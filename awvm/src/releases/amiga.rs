...
// Source: releases/amiga/amiga.py
...
pub const KNOWN_LABELS: &[(u32, &[(u32, &str)])] = &[
    ...
    (2, &[
        (0x0090, "KILL_CHANNEL_ROUTINE"),
        (0x0091, "LIKELY_A_COPY_PROTECTION_MECHANISM"),
        (0x00B3, "SHUTDOWN_VM"),
        (0x00BC, "SOME_VIDEO_BUFFER_MAGIC"),
        (0x0142, "ANOTHER_UNCLEAR_VIDEO_BUFFER_MANIPULATION"),
        (0x0155, "UNCLEAR_VIDEO_BUFFER_MANIPULATION"),
        ...
        (0x1DE3, "A_VIDEO_ROUTINE_OF_SOME_SORT"),
        ...
        (0x3A1B, "A_CALM_ALIEN_POOL_BEFORE_LESTERS_ARRIVAL"),
...
pub const POSSIBLY_UNUSED_CODEBLOCKS: &[(u32, &[u32])] = &[
    (0, &[]),
    (1, &[]),
    (2, &[0x004B, 0x014D, 0x018F, 0x0196, 0x0439, 0x055D, 0x0590, 0x085B, 0x08E3, 0x0C27, 0x0CB9, 0x163F, 0x2CFC, 0x2DC5, 0x341A, 0x3710, 0x384B, 0x4116, 0x413F, 0x429C, 0x42C4, 0x4641, 0x4898, 0x4AA9, 0x4B55]),
    (3, &[]),
    (4, &[]),
    (5, &[]),
    (6, &[]),
