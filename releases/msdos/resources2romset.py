...
class MSDOSROMSet():
    def __init__(self, input_dir, output_dir):
        ...
        self.output_dir = f"{output_dir}/msdos/romset"
    ...
    def generate_video2_rom(self):
        ...
        v2data = open(f"{self.input_dir}/resource-0x{video2_resource_id:02x}.bin", "rb").read()
...
if __name__ == '__main__':
    ...
    romset = MSDOSROMSet(input_dir, output_dir)
    romset.generate()
